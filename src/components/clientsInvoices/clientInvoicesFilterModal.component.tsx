...
export const ClientInvoicesFilterModal: React.FC<FilterModalProps> = ({
  open,
  handleClose,
}) => {
  ...
  const [filters, setFilters] = useState({
    ...
    paymentStatus: invoicesState.filters.paymentStatus,
  });
  const dispatch = useDispatch();

  const handleConfirmClientsFilters = () => {
    dispatch(handleSubmitInvoicesFilters(filters));
    handleClose();
  };
