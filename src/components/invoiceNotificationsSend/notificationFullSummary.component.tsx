...
interface NotificationFullSummaryProps {
  finalTotal: number;
  total: number;
  totalTax: number;
...
export const NotificationFullSummary: React.FC<
  NotificationFullSummaryProps
> = ({ finalTotal, total, totalTax, totalDiscount, taxPercentage }) => {
