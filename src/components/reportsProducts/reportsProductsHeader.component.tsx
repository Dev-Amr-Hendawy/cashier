...
import { ReportProductsModal } from "@myCash/components";
import { FiltersHandlers } from "@myCash/types";

interface ReportsProductsHeaderProps {
...
export const ReportsProductsHeader: React.FC<ReportsProductsHeaderProps> = ({
  productsFilters,
}) => {
  const { t } = useTranslation();
  const [addReportOpen, setAddReportOpen] = useState(false);
  const { filters, setFilterHandler, clearFilters } = productsFilters;
        ...
        <MainIcon
          ...
          onClick={() => {
            ...
            queryClient.invalidateQueries({
              queryKey: [REPORTS_PRODUCTS_QUERY_KEY],
            });
          }}
        />
      </StyledHeaderStack>
